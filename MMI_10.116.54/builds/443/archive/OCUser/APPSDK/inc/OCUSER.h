...
#define OC3DM_SHIFTX				(OC3DM_FIRST + 1)
#define OC3DM_SHIFTY				(OC3DM_FIRST + 2)
#define OC3DM_SHIFTZ				(OC3DM_FIRST + 3)
#define OC3DM_ROTATEX				(OC3DM_FIRST + 4)
#define OC3DM_ROTATEY				(OC3DM_FIRST + 5)
#define OC3DM_ROTATEZ				(OC3DM_FIRST + 6)
#define OC3DM_SETXYZLENGTH			(OC3DM_FIRST + 7)
#define OC3DM_ADDTUBE				(OC3DM_FIRST + 8)
#define OC3DM_ADDCURVEDTUBE			(OC3DM_FIRST + 9)
#define OC3DM_CLEARPIPE				(OC3DM_FIRST + 10)
#define OC3DM_SCALE					(OC3DM_FIRST + 11)
#define OC3DM_RESET					(OC3DM_FIRST + 12)
#define OC3DM_ADDCUBOID				(OC3DM_FIRST + 13)
